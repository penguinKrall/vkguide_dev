...
void VulkanEngine::draw() {
  ...
  _frameNumber++;
  // fmt::print("_frameNumber % FRAME_OVERLAP: {}\n",
...
void VulkanEngine::init_vulkan() {
  ...
  fmt::print("engine.cpp init_vulkan() _graphicsQueueFamily: {}",
             _graphicsQueueFamily);
...
void VulkanEngine::init_background_pipelines() {
  ...
  if (!vkutil::load_shader_module("../shaders/compiled/gradient.comp.spv",
